...
function App() {
  ...
  const [sections, setSections] = useState({
    educations: [   // array of education form objects
      {
        degree: "",
        schoolName: "",
        location: "",
    ...
    experiences: [    // array of experience form objects
      {
        companyName: "",
        positionTitle: "",
        location: "",
...
// this function captures the change, updates the app's state to reflect the new info. The user's input is reflected throughout the app.
  ...
  function handleSectionChange(e){
    ...
    setSections({ // update the sections state object with the newly input value from user
      ...sections,  // shallow copy the sections state object using spread operator
      [arrayName]: section.map((obj) => {  // Update the specific array (educations or experiences)
